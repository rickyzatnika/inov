    ...
    <>
      <AOSWrapper>
        <div className="w-full min-h-screen" id="wish">
          ...
          <div className="w-full pt-10 pb-24 relative overflow-y-scroll h-[95%] bg-gradient-to-b from-[#7ca6d6] via-white to-[#7ca6d6]  pl-3 lg:px-10 ">
            ...
            <ol className=" p-8   ">
              <li className="w-full border-b pb-4 border-zinc-300">
                ...
                >
                  Happy wedding Inov & Irsan, semoga menjadi keluarga yang
