...
const Event = ({ guest }) => {
  ...
  return (
    <AOSWrapper>
      <div
        ref={sectionRef}
        className="w-full min-h-5xl py-16 overflow-hidden bg-gradient-to-tr from-[#F5F5F5] to-[#FFFFFF] relative px-2 "
        id="event"
      >
        <div className="absolute -bottom-20 z-10 -right-14 ">
          <Image
            data-aos="fade-down"
                ...
                <div className="w-full md:w-5/6 lg:w-2/6 min-h-screen bg-black/70  fixed z-[999999999] flex items-center justify-center top-0 right-0">
                  ...
                  >
                    <form
                      ...
                      className="w-full relative  shadow-lg overflow-hidden shadow-black/20 bg-gradient-to-b from-[#fcfcfc] to-[#e3ebf3] rounded z-50 h-auto  px-3 pt-10 pb-10 flex flex-col items-center justify-center gap-3"
                    >
